Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Showing name and comments like Periscope"

  s.homepage     = "https://github.com/yoavlt/PeriscommentView"
  ...
  s.source       = { :git => "https://github.com/yoavlt/PeriscommentView.git", :tag => "0.0.1" }
